...
class IGEVStereo(nn.Module):
    def __init__(self, args=None, imagenet_norm=False):
        ...
        self.cnet = MultiBasicEncoder(output_dim=[self.args.hidden_dims, context_dims], norm_fn="batch", downsample=self.args.n_downsample)
        self.update_block = BasicSelectiveMultiUpdateBlock(self.args, hidden_dims=self.args.hidden_dims)
    ...
    def forward(self, image1, image2, iters=None, flow_init=None, test_mode=None):
