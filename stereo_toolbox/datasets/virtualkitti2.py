...
class VirtualKITTI2_Dataset(Dataset):
    """
    Inputs:
    - split: 'train'
    ...
    """
    def __init__(self, split: str, training: bool, root_dir='/data1/xp/VirtualKITTI2/'):
        ...
        dataset_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                    f'datasets_lists/virtualkitti2/{self.split}.txt')
    ...
    def load_disp(self, filename: str):
        ...
        depth = np.array(Image.open(filename), dtype=np.float32) / 100
