...
class DrivingStereo_Dataset(Dataset):
    """
    Inputs:
    - split: 'train_half', 'test_half', 'test_full',
            ...
            'test_half_sunny', 'test_half_rainy', 'test_half_foggy', 'test_half_cloudy',
            'test_full_sunny', 'test_full_rainy', 'test_full_foggy', 'test_full_cloudy',
    ...
    def __init__(self, split: str, training: bool, root_dir='/data/xp/Driving_Stereo/', imagenet_norm=True):
        assert split in ['train_half', 'test_half', 'test_full',
                        ...
                        'train_full_sunny', 'train_full_rainy', 'train_full_foggy', 'train_full_cloudy',
                        'test_half_sunny', 'test_half_rainy', 'test_half_foggy', 'test_half_cloudy',
                        'test_full_sunny', 'test_full_rainy', 'test_full_foggy', 'test_full_cloudy',], "Invalid split name"
        self.split = split
        self.training = training

        dataset_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                    f'datasets_lists/drivingstereo/{self.split}.txt')
