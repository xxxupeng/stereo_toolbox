...
class Booster_Dataset(Dataset):
    ...
    """
    def __init__(self, split: str, training: bool, root_dir='/data1/xp/Booster/'):
        ...
        dataset_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                    f'datasets_lists/booster/{self.split}.txt')
    ...
    def __getitem__(self, index):
        ...
        mask_image = self.load_noc_mask(self.disp_images[index].replace('disp_00.npy', 'mask_00.png'))
